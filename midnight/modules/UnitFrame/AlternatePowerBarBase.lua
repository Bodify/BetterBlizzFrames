...
BBFAlternatePowerBarBaseMixin = {};

function BBFAlternatePowerBarBaseMixin:OnLoad()
    self.isEnabled = nil;
    self:Initialize();
end

function BBFAlternatePowerBarBaseMixin:Initialize()
    self:UpdateArt();
...
function BBFAlternatePowerBarBaseMixin:OnUpdate()
...
function BBFAlternatePowerBarBaseMixin:OnEvent(event, ...)
...
function BBFAlternatePowerBarBaseMixin:SetBarEnabled(enabled)
...
function BBFAlternatePowerBarBaseMixin:IsBarEnabled()
    return self.isEnabled;
end

function BBFAlternatePowerBarBaseMixin:UpdatePower()
    local currentPower = self:GetCurrentPower();
    self:SetValue(currentPower);
    self.currentPower = currentPower;
end

function BBFAlternatePowerBarBaseMixin:UpdateMinMaxPower()
...
function BBFAlternatePowerBarBaseMixin:GetUnit()
...
function BBFAlternatePowerBarBaseMixin:UpdateArt()
    -- Implement in a base mixin specific to what kind of unit UI is displaying the bar
    -- (ex a PlayerFrame-specific base mixin)
end

function BBFAlternatePowerBarBaseMixin:UpdateIsAliveState()
    -- Implement in a base mixin specific to what kind of unit UI is displaying the bar
    -- (ex a PlayerFrame-specific base mixin)
end

function BBFAlternatePowerBarBaseMixin:AttachBarToUnitUI()
    -- Implement in a base mixin specific to what kind of unit UI is displaying the bar
    -- (ex a PlayerFrame-specific base mixin)
end

function BBFAlternatePowerBarBaseMixin:RemoveBarFromUnitUI()
    -- Implement in a base mixin specific to what kind of unit UI is displaying the bar
    -- (ex a PlayerFrame-specific base mixin)
end
...
function BBFAlternatePowerBarBaseMixin:EvaluateUnit()
    -- Implement in derived mixins
    -- Should evalute unit's current class, spec, power type, etc, and SetBarEnabled accordingly
end

function BBFAlternatePowerBarBaseMixin:OnBarEnabled()
    -- Implement in derived mixins
end

function BBFAlternatePowerBarBaseMixin:OnBarDisabled()
    -- Implement in derived mixins
end

function BBFAlternatePowerBarBaseMixin:GetCurrentPower()
    -- Implement in derived mixins
end

function BBFAlternatePowerBarBaseMixin:GetCurrentMinMaxPower()
    -- Implement in derived mixins
end
...
BBFPlayerFrameAlternatePowerBarBaseMixin = CreateFromMixins(BBFAlternatePowerBarBaseMixin);

function BBFPlayerFrameAlternatePowerBarBaseMixin:Initialize()
    self.textLockable = 1;
    ...
    BBFAlternatePowerBarBaseMixin.Initialize(self);
...
function BBFPlayerFrameAlternatePowerBarBaseMixin:OnShow()
    self.pauseUpdates = false;
    self:UpdatePower();
    self:UpdateTextString();
end

function BBFPlayerFrameAlternatePowerBarBaseMixin:OnHide()
    self.pauseUpdates = true;
end

function BBFPlayerFrameAlternatePowerBarBaseMixin:OnEvent(event, ...)
    BBFAlternatePowerBarBaseMixin.OnEvent(self, event, ...);
    self:TextStatusBarOnEvent(event, ...);
end

function BBFPlayerFrameAlternatePowerBarBaseMixin:AttachBarToUnitUI()
end

function BBFPlayerFrameAlternatePowerBarBaseMixin:RemoveBarFromUnitUI()
end

function BBFPlayerFrameAlternatePowerBarBaseMixin:UpdateArt()
...
function BBFPlayerFrameAlternatePowerBarBaseMixin:UpdateIsAliveState()
