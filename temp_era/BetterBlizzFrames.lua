        ...
        if not BetterBlizzFramesDB.scStart then
            ...
            C_Timer.After(7, function()
                ...
                if BetterBlizzFramesDB.playerAuraFiltering then
                    ...
                    DEFAULT_CHAT_FRAME:AddMessage(L["|A:QuestNormal:16:16|a Important Note: Moving BuffFrame/DebuffFrame is now optional but on by default. Depending on your addons BetterBlizzFrames might've taken control over other things moving it. Please double check your aura settings in the Buffs & Debuffs section."])
                end
...
local function executeCustomCode()
    if BetterBlizzFramesDB and BetterBlizzFramesDB.customCode then
        ...
        if func then
            ...
            print("|A:gmchat-icon-blizz:16:16|a Better|cff00c0ffBlizz|rFrames: " .. L["Error in custom code"] .. ":", errorMsg)
        end
    end
end
