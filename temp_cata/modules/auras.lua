...
local function AdjustAuras(self, frameType)
    ...
    for i = 1, 40 do
        ...
        if debuffFrame and debuffFrame:IsShown() then
            ...
            local spellName, icon, count, debuffType, duration, expirationTime, sourceUnit, isStealable, nameplateShowPersonal, spellId, canApplyAura, isBossDebuff, castByPlayer, nameplateShowAll, timeMod = UnitDebuff(unit, i)
                            ...
                            auraFrame:HookScript("OnMouseDown", function(self, button)
                                if IsShiftKeyDown() and IsAltKeyDown() then
                                    ...
                                    if button == "LeftButton" then
                                        ...
                                        print("|A:gmchat-icon-blizz:16:16|a Better|cff00c0ffBlizz|rFrames: " .. spellName .. " (" .. spellId .. ") was added to |cff00ff00whitelist|r.")
                                    elseif button == "RightButton" then
                                        BBF.auraBlacklist(auraFrame.spellId)
                                        print("|A:gmchat-icon-blizz:16:16|a Better|cff00c0ffBlizz|rFrames: " .. spellName .. " (" .. spellId .. ") was added to |cffff0000blacklist|r.")
                                    end
                                end
                            end)
