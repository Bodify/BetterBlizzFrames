...
function BBF.UpdateMaelstromWeaponBar()
    ...
    local show = BetterBlizzFramesDB.shamanMaelstromCombos
        and GetSpecialization() == ENHANCEMENT_SPEC_INDEX and not LegacyOwnsDisplay()
...
function BBF.CreateMaelstromWeaponBar()
    ...
    if GetSpecialization() ~= ENHANCEMENT_SPEC_INDEX then return end
...
function BBF.ShamanLegacyMaelstrom()
    ...
    local function UpdateShamanLegacyCombo()
        ...
        local stacks = GetSpecialization() == ENHANCEMENT_SPEC_INDEX and GetStacks() or 0
