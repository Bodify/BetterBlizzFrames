...
local interruptList = {
    ...
    [72] = true,         -- Shield Bash (Warrior)
    [8042] = true,       -- Earth Shock (Shaman)
    [19244] = true,      -- Spell Lock (Warlock)
    [19675] = true,      -- Feral Charge Effect (Druid)
    ...
    [33871] = true,      -- Shield Bash (Warrior)
    [24259] = true,      -- Spell Lock (Warlock)
    [43523] = true,      -- Unstable Affliction (Warlock)
    [119911] = true,     -- Optical Blast (Warlock Observer)
    [115781] = true,     -- Optical Blast (Warlock Observer)
    [26090] = true,      -- Pummel (Gorilla)
    [50479] = true,      -- Nethershock
